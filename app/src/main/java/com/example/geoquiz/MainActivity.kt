...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cheatButton.setOnClickListener { view ->
            ...
            val numberOfHints = quizViewModel.numberOfHints
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_CODE_CHEAT) {
            ...
            quizViewModel.cheatIndex = data?.getIntExtra(EXTRA_CHEAT_INDEX, 0) ?: 0
            quizViewModel.numberOfHints = data?.getIntExtra(EXTRA_NEW_NUMBER_OF_HINTS, 0) ?: 0
        }
    }
    ...
    private fun checkAnswer(userAnswer: Boolean) {
        ...
        quizViewModel.checkQuestionCheat()
